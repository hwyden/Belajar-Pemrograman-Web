                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url(); ?>menu/hapusSubMenu/<?= $sm['id']; ?>" class="badge badge-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus menu ini?');">hapus</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
            ...
            <form action="<?= base_url('menu/submenu'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="namaSubMenu">Nama Sub Menu</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="icon" name="icon" placeholder="Submenu icon (Search in Fontawesome.com)">
                    </div>
                    <div class="form-group">
